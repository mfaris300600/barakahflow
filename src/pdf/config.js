...
import { currentHijriMonth, currentHijriYear } from '~/lib/hijri';
...
class PdfConfig {
	constructor( configOverrides = {} ) {
		// Hijri year (e.g. 1447) and Hijri month index (0 = Muharram, 11 = Dhu al-Hijjah).
		this.year = currentHijriYear();
		this.month = currentHijriMonth() - 1;
		...
		// Dates are Hijri MM-DD (month index 1..12, day 1..30).
		this.specialDates = [
			{ date: '01-01', value: 'Islamic New Year', type: HOLIDAY_DAY_TYPE },
			{ date: '01-10', value: 'Day of Ashura', type: HOLIDAY_DAY_TYPE },
			{ date: '03-12', value: 'Mawlid an-Nabi', type: HOLIDAY_DAY_TYPE },
			{ date: '07-27', value: 'Isra and Miʿraj', type: HOLIDAY_DAY_TYPE },
			{ date: '08-15', value: 'Laylat al-Baraʾa', type: EVENT_DAY_TYPE },
			{ date: '09-01', value: 'Ramadan begins', type: HOLIDAY_DAY_TYPE },
			{ date: '09-27', value: 'Laylat al-Qadr (est.)', type: EVENT_DAY_TYPE },
			{ date: '10-01', value: 'Eid al-Fitr', type: HOLIDAY_DAY_TYPE },
			{ date: '12-09', value: 'Day of Arafah', type: HOLIDAY_DAY_TYPE },
			{ date: '12-10', value: 'Eid al-Adha', type: HOLIDAY_DAY_TYPE },
		];
