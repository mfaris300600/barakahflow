...
class MonthOverviewPage extends React.Component {
	...
	renderHabitsHeader() {
		...
		let currentDate = startOfHijriMonth( date );
	...
	renderDay( day ) {
		return (
			...
			>
				<Text style={ this.styles.habitDayDate }>{hijriInfo( day ).hd}</Text>
	...
	renderHabitSquares() {
		...
		let currentDate = startOfHijriMonth( this.props.date );
		const end = endOfHijriMonth( this.props.date );
		const squares = [];
		while ( ! currentDate.isAfter( end ) ) {
					...
					<View style={ this.styles.page }>
						<View style={ this.styles.header }>
							<View style={ this.styles.meta }>
								<Text style={ this.styles.title }>{formatHijriMonth( date )}</Text>
							</View>
							<MiniCalendar
								date={ date }
